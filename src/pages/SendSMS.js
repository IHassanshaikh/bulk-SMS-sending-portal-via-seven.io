...
export default function SendSMS() {
    ...
    const [batchSize, setBatchSize] = useState(""); // Number of messages per batch
    const [campaignName, setCampaignName] = useState(""); // Name for this sending job
            ...
            <div className="glass-panel" style={{ padding: "40px", maxWidth: "800px" }}>
                ...
                <div style={{ marginBottom: "40px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "20px" }}>
                        ...
                        <div>
                            <label style={{ display: "block", marginBottom: "8px", color: "var(--text-secondary)" }}>Batch Size</label>
                            <input
                                type="number"
                                placeholder="50, 100..."
                                min="1"
